...
export default function ButtonAppBar() {
  ...
  const handleChange = (e) => {
    ...
    if (value === "EthereumMainnet") {
      account.setbalanceunit("ETH");
    } else if (value === "GoreliTestnet") {
      account.setbalanceunit("GoerliETH");
    } else {
      account.setbalanceunit("Matic");
    }
  };
  return (
    <Box sx={{ flexGrow: 1 }}>
        ...
        >
          ...
          <FormControl fullWidth={false}>
            ...
            >
              ...
              <MenuItem value={"EthereumMainnet"}>Ethereum Mainnet</MenuItem>
              <MenuItem value={"GoreliTestnet"}>Goreli Testnet</MenuItem>
            </Select>
          </FormControl>
          <Button
            color="inherit"
